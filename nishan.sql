...
ALTER TABLE TBL_USER_ROLE ADD CONSTRAINT FK_USERNAME FOREIGN KEY(username) REFERENCES TBL_USER(username) ON DELETE CASCADE;
...
alter table tbl_user add email VARCHAR2(255);
alter table tbl_user modify email varchar2(255) not null;
...
DESC TBL_USER;
ALTER TABLE TBL_ORDER ADD STATUS CHAR(1) DEFAULT 0;
...
ALTER TABLE TBL_ORDER ADD CONSTRAINT fk_user_id FOREIGN KEY(user_id) REFERENCES TBL_USER(user_id) ON DELETE CASCADE;
...
ALTER TABLE TBL_ORDER ADD contact VARCHAR2(20) NOT NULL;
DESC TBL_ORDER;
ALTER TABLE TBL_ORDER ADD STATUS CHAR(1) DEFAULT 0;
SELECT * FROM TBL_ORDER;
...
ALTER TABLE TBL_IMAGE ADD PUBLIC_ID VARCHAR2(100);

SELECT * FROM TBL_IMAGE;

SELECT IMAGE_NAME FROM TBL_IMAGE I, TBL_PASHMINA P
WHERE I.PASHMINA_ID = P.PASHMINA_ID
AND P.PASHMINA_ID = '221';
